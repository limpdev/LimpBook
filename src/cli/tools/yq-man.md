...
> [!TIP]
> yq is a portable command-line data file processor. See [GitHub](https://github.com/mikefarah/yq/) and [GitBook](https://mikefarah.gitbook.io/yq/) for detailed documentation and examples.
