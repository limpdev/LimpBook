# Mogrify - An Extension of Image Magick
...
```
  ...
  -word-break type     sets whether line breaks appear wherever the text would otherwise overflow  -write-mask filename associate a write mask with the image
