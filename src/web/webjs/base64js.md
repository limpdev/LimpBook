# Convert To `base64` w/ Javascript

> [!NOTE]
> Honestly, I straight up ripped this motherfucker from **cssportal** -\> it's more than just the conversion logic as it includes the logic for a drag n'drop handler
