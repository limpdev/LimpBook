...
> Changes the color of *highlighted* text on a webpage!

```css
::selection {
	background-color: #91919130; /* Change to your preferred color */
...
> Incorporates a ripple animation on page clicks, acting as a sort of feedback mechanism!
...
.markdown-body {
	...
	--fontStack-monospace: "RedditMono Nerd Font", "UbuntuSansM NFM", Menlo, Liberation Mono, monospace;
...
.markdown-body {
	...
	font-family: "RedditSans Nerd Font", "SFProDisplayNF-Regular", BlinkMacSystemFont, "Segoe UI", Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji";
	font-size: 16.5px;
	line-height: 1.4;
...
.markdown-body pre,
.markdown-body samp {
	font-family: "RedditMono Nerd Font", monospace;
	font-size: 1em;
}
...
.markdown-body code,
.markdown-body samp {
	font-family: "RedditMono Nerd Font", "SF Mono Powerline", Menlo, monospace;
	font-size: 12px;
}
