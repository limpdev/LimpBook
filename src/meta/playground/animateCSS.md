...
Another thing from [Daniel Eden](https://daneden.me "Daniel Eden") and [friends](#contributors "Contributors")
...
See the Pen [Prefers-reduce-motion media query](https://codepen.io/eltonmesquita/pen/oNjGGbw) by Elton Mesquita ([@eltonmesquita](https://codepen.io/eltonmesquita)) on [CodePen](https://codepen.io).
