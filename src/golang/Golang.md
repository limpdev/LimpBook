...
---
---
## <span style='color:var(--mk-color-turquoise)'>Index</span>
...
## <span style='color:var(--mk-color-red)'>Credits</span>
...
# <span style='color:var(--mk-color-turquoise)'>Basic Syntax</span>
...
## <span style='color:var(--mk-color-turquoise)'>Operators</span>
---
### Arithmetic
...
---
## <span style='color:var(--mk-color-turquoise)'>Declarations</span>
...
## <span style='color:var(--mk-color-turquoise)'>Functions</span>
## Built-in Types
```go
bool
...
## <span style='color:var(--mk-color-turquoise)'>Arrays, Slices, Ranges</span>
...
# <span style='color:var(--mk-color-turquoise)'>Concurrency</span>
...
# <span style='color:var(--mk-color-turquoise)'>Snippets</span>
